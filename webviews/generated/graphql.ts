...
export type OrgPrQueryVariables = Exact<{
  org: Scalars['String'];
  repo: Scalars['String'];
}>;


export type OrgPrQuery = (
  { __typename?: 'Query' }
  & { organization?: Maybe<(
    { __typename?: 'Organization' }
    & { repository?: Maybe<(
...
export const OrgPrDocument = gql`
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    OrgPR(variables: OrgPrQueryVariables, requestHeaders?: Headers): Promise<OrgPrQuery> {
      return withWrapper(() => client.request<OrgPrQuery>(print(OrgPrDocument), variables, requestHeaders));
    },
